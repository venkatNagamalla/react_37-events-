...
class Events extends Component {
  ...
  getActiveItemStatus = () => {
    ...
    const activeItem = eventsList.find(eachEvent => eachEvent.id === activeId)
    if (activeItem) {
      return activeItem.registrationStatus
    }
    return ''
  }
  ...
  renderRegistrationStatus = () => (
    <div className="active-regis-container">
      <ActiveEventRegistrationDetails
        eventStatus={this.getActiveItemStatus()}
      />
    </div>
  )
